...
-- Insert students --
INSERT INTO students (username, password, email, first_name, last_name, phone_number, address, ssn, dob, gender) VALUES ('johndoe', 'password', 'johndoe@example.com', 'John', 'Doe', 1234567890, '123 Main St', 123456789, '1990-01-01', 'M');
INSERT INTO students (username, password, email, first_name, last_name, phone_number, address, ssn, dob, gender) VALUES ('janedoe', 'password', 'janedoe@example.com', 'Jane', 'Doe', 1234567891, '124 Main St', 123456788, '1991-02-02', 'M');
INSERT INTO students (username, password, email, first_name, last_name, phone_number, address, ssn, dob, gender) VALUES ('bobsmith', 'password', 'bobsmith@example.com', 'Bob', 'Smith', 1234567892, '125 Main St', 123456787, '1992-03-03', 'M');
INSERT INTO students (username, password, email, first_name, last_name, phone_number, address, ssn, dob, gender) VALUES ('jennysmith', 'password', 'jennysmith@example.com', 'Jenny', 'Smith', 1234567893, '126 Main St', 123456786, '1993-04-04', 'M');
INSERT INTO students (username, password, email, first_name, last_name, phone_number, address, ssn, dob, gender) VALUES ('tomhanks', 'password', 'tomhanks@example.com', 'Tom', 'Hanks', 1234567894, '127 Main St', 123456785, '1994-05-05', 'M');
INSERT INTO students (username, password, email, first_name, last_name, phone_number, address, ssn, dob, gender) VALUES ('angelinajolie', 'password', 'angelinajolie@example.com', 'Angelina', 'Jolie', 1234567895, '128 Main St', 123456784, '1995-06-06', 'M');
INSERT INTO students (username, password, email, first_name, last_name, phone_number, address, ssn, dob, gender) VALUES ('bradpitt', 'password', 'bradpitt@example.com', 'Brad', 'Pitt', 1234567896, '129 Main St', 123456783, '1996-07-07', 'M');
INSERT INTO students (username, password, email, first_name, last_name, phone_number, address, ssn, dob, gender) VALUES ('emmaroberts', 'password', 'emmaroberts@example.com', 'Emma', 'Roberts', 1234567897, '130 Main St', 123456782, '1997-08-08', 'M');
INSERT INTO students (username, password, email, first_name, last_name, phone_number, address, ssn, dob, gender) VALUES ('leonardodicaprio', 'password', 'leonardodicaprio@example.com', 'Leonardo', 'DiCaprio', 1234567898, '131 Main St', 123456781, '1998-09-09', 'M');
INSERT INTO students (username, password, email, first_name, last_name, phone_number, address, ssn, dob, gender) VALUES ('sandrabullock', 'password', 'sandrabullock@example.com', 'Sandra', 'Bullock', 1234567899, '132 Main St', 123456780, '1999-10-10', 'M');
